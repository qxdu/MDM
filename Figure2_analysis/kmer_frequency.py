...
generator_training_datapath = "../dataset/diffusion_promoter/sequence_data.txt"
generator_sampling_datapath = "./samples/diff_rand_10000.txt" # mdm
# generator_sampling_datapath = "./samples/ddsm_epoch_200.txt" # ddsm
# generator_sampling_datapath = "./samples/wgan_rand_10000.txt" # wgan
# generator_sampling_datapath = "./samples/ppm_rand_10000.txt" # pssm
# generator_sampling_datapath = "./samples/output_genepromodiff.txt" # promodiff
