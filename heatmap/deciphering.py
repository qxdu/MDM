...
total_feature = open_fa("/home/qxdu/AI_based_promoter_design/evaluation/gap_simulation/in_silico_simulation_3/falsify_data/falsify_data.txt")
...
for epoch in tqdm_epoch:
    ...
    if ( (epoch + 1) % save_steps == 0):
        torch.save(score_model.state_dict(), '../simulation/ddsm.pth')
        ...
        write_fa("../simulation/samples/epoch_{}.txt".format(epoch + 1), allsamples)
        score_model.train()



'''
2. generation for ddsm
'''

score_model.load_state_dict(torch.load('/home/qxdu/AI_based_promoter_design/revisions/simulation/ddsm.pth'))
score_model.eval()
torch.set_default_dtype(torch.float32)
...
allsamples = torch.tensor(allsamples, dtype=float)
allsamples = onehot2seq(allsamples, seq_len=50)
write_fa("/home/qxdu/AI_based_promoter_design/revisions/simulation/samples/final_35000.txt", allsamples)
...
origin = '/home/qxdu/AI_based_promoter_design/evaluation/gap_simulation/in_silico_simulation_3/result/falsify.txt'
ddsm = "/home/qxdu/AI_based_promoter_design/revisions/simulation/samples/final_35000.txt"
mdm = '/home/qxdu/AI_based_promoter_design/evaluation/gap_simulation/in_silico_simulation_3/result/diffusion.txt'


pfm_0266 = "/home/qxdu/AI_based_promoter_design/evaluation/gap_simulation/in_silico_simulation_3/library/MA0266.1.pfm"
pfm_0267 = "/home/qxdu/AI_based_promoter_design/evaluation/gap_simulation/in_silico_simulation_3/library/MA0267.1.pfm"
pfm_0277 = "/home/qxdu/AI_based_promoter_design/evaluation/gap_simulation/in_silico_simulation_3/library/MA0277.1.pfm"
pfm_0280 = "/home/qxdu/AI_based_promoter_design/evaluation/gap_simulation/in_silico_simulation_3/library/MA0280.1.pfm"
pfm_0300 = "/home/qxdu/AI_based_promoter_design/evaluation/gap_simulation/in_silico_simulation_3/library/MA0300.1.pfm"
pfm_0306 = "/home/qxdu/AI_based_promoter_design/evaluation/gap_simulation/in_silico_simulation_3/library/MA0306.1.pfm"

pfm_list = [266, 267, 277, 280, 300, 306]

res_natural, res_ddsm, res_mdm = [], [], []
item_list = []

cnt = 0
for item in tqdm(itertools.product(pfm_list, pfm_list)):
    PFM1 = "/home/qxdu/AI_based_promoter_design/evaluation/gap_simulation/in_silico_simulation_3/library/MA0{}.1.pfm".format(str(item[0]))
    PFM2 = "/home/qxdu/AI_based_promoter_design/evaluation/gap_simulation/in_silico_simulation_3/library/MA0{}.1.pfm".format(str(item[1]))
    ...
    dist = [dist_origin, dist_ddsm, dist_mdm]
...
# plotnamefinal = "/home/qxdu/AI_based_promoter_design/revisions/simulation/gap_ddsm.png"

# ax = sns.heatmap(data=res_mdm,annot=False, linewidths=0.3,cmap="RdBu_r", vmin=0, vmax=12, fmt=".1f")  # n_colors = 20
# plotnamefinal = "/home/qxdu/AI_based_promoter_design/revisions/simulation/gap_mdm.png"

ax = sns.heatmap(data=res_delta,annot=False, linewidths=0.3,cmap="RdBu_r", vmin=-3, vmax=3, fmt=".1f")  # n_colors = 20
plotnamefinal = "/home/qxdu/AI_based_promoter_design/revisions/simulation/gap_delta.png"

plt.yticks(rotation=0)
ax.set(xlabel="Motif 2", ylabel="Motif 1")
