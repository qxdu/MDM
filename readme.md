...
| spacer region| https://github.com/qxdu/MDM/blob/master/Figure2_analysis/gap_simulation.py | The inter motif distance is typically around 17 bp|
...
| 6-mer frequency | https://github.com/qxdu/MDM/blob/master/Figure2_analysis/kmer_frequency.py  https://github.com/qxdu/MDM/blob/master/Figure2_analysis/benchmark_analysis.py | 6-mer frequency of samples generated by models |
| sample diversity | https://github.com/qxdu/MDM/blob/master/Figure3_collapse/collapse_analysis.py  https://github.com/qxdu/MDM/blob/master/Figure2_analysis/diversity_boxplot.py | sample diversity of generated sequences | 
| gc content | https://github.com/qxdu/MDM/blob/master/Figure2_analysis/benchmark_analysis.py | gc content levels of generated sequences |  
  

All available results have been provided in separate folders. A simple diagram of k-mer frequency of our MDM is as follows:
...
<div align=center>
<img src="https://github.com/qxdu/MDM/blob/master/Figure3_collapse/results/Supp_diversity.png" width="700px">
</div>

Our evaluation codes are under https://github.com/qxdu/MDM/tree/master/Figure3_collapse , and results of multiple criterias have also been provided.

## Weak Signal Decoupling
The abilities of model to decouple complex signals and preserve natural weak signals are particularly important. We conducted an in silico experiment to evaluate these capacities of our model. Relevant codes are provided in https://github.com/qxdu/MDM/tree/master/Figure3_heatmap/ . Samples generated by our models and results are provided in https://github.com/qxdu/MDM/tree/master/Figure3_heatmap/samples . All available motifs are downloaded from [JASPAR](https://jaspar.elixir.no/) .

A simple results of our MDM is shown as follows:

<div align=center>
<img src="https://github.com/qxdu/MDM/blob/master/Figure3_heatmap/results/Fig3_heat_mdm.png" width="700px">
</div>
...
## Citations
[1] Wang H, Du Q, Wang Y, et al. GPro: generative AI-empowered toolkit for promoter design[J]. Bioinformatics, 2024, 40(3): btae123.

[2] Wang Y, Wang H, Wei L, et al. Synthetic promoter design in Escherichia coli based on a deep generative network[J]. Nucleic Acids Research, 2020, 48(12): 6403-6412.

[3] Hoogeboom E, Nielsen D, Jaini P, et al. Argmax flows and multinomial diffusion: Learning categorical distributions[J]. Advances in Neural Information Processing Systems, 2021, 34: 12454-12465.

[4] Avdeyev P, Shi C, Tan Y, et al. Dirichlet Diffusion Score Model for Biological Sequence Generation[J]. arXiv preprint arXiv:2305.10699, 2023.

[5] Guo Z, Liu J, Wang Y, et al. Diffusion models in bioinformatics and computational biology[J]. Nature Reviews Bioengineering, 2023: 1-19.
